...
if "compact_view" not in st.session_state: st.session_state.compact_view = False
...
with right_pane:
    ...
    def render_task_deck():
        ...
        # Space Saving Layout Switch
        st.session_state.compact_view = st.checkbox("🔍 Enable Ultra-Compact View (Shrink Heights)", value=st.session_state.compact_view, key="compact_toggle_widget")
